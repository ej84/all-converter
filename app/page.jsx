...
export default function Home() {
  return (
    <>
      <Nav />
      <main className="flex min-h-screen flex-col items-center justify-normal p-28">
        <div className="container mx-auto">
          <div className="flex justify-center">
            <h1 className="text-4xl font-bold mb-4">All You Can Convert</h1>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10 p-10">
            <div className="btn1">
